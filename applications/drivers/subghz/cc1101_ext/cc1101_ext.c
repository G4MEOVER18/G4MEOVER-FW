...
bool subghz_device_cc1101_ext_alloc(SubGhzDeviceConf* conf) {
    ...
    subghz_device_cc1101_ext->spi_bus_handle =
        (g4meover_settings.spi_cc1101_handle == SpiDefault ?
    ...
    if(g4meover_settings.spi_cc1101_handle == SpiExtra) {
...
void subghz_device_cc1101_ext_free(void) {
    ...
    if(g4meover_settings.spi_nrf24_handle == SpiDefault ||
       subghz_device_cc1101_ext->amp_and_leds) {
        furi_hal_gpio_init_simple(&gpio_ext_pc3, GpioModeAnalog);
    } else if(g4meover_settings.spi_nrf24_handle == SpiExtra) {
