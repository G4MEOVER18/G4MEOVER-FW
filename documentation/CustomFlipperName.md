...
## Instruction
1. Go to G4MEOVER -> Misc -> Spoofing Options -> Flipper Name
...
3. You will need to exit from G4MEOVER app and Flipper will automatically reboot!
...
Currently, changing Flipper name on G4MEOVER Firmware also affects:
